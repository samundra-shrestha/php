            ...
            <form class="space-y-6" action="/session" method="POST">
                <div>
                    ...
                    <?php if (isset($errors['email'])) : ?>
                        <p class="mt-3 text-sm leading-6 text-red-600 text-capitalize"><?= $errors['email'] ?></p>
                    <?php endif; ?>
                </div>
                ...
                <div>
                    ...
                    <?php if (isset($errors['password'])) : ?>
                        <p class="mt-3 text-sm leading-6 text-red-600 text-capitalize"><?= $errors['password'] ?></p>
                    <?php endif; ?>
                </div>
